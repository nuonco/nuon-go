...
func (m *AppAppInstallerMetadata) validateCreatedBy(formats strfmt.Registry) error {
...
func (m *AppAppInstallerMetadata) contextValidateCreatedBy(ctx context.Context, formats strfmt.Registry) error {
