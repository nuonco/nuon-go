...
func (m *AppRunnerGroup) validateCreatedBy(formats strfmt.Registry) error {
...
func (m *AppRunnerGroup) contextValidateCreatedBy(ctx context.Context, formats strfmt.Registry) error {
