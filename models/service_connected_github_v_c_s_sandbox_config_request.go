...
func (m *ServiceConnectedGithubVCSSandboxConfigRequest) validateDirectory(formats strfmt.Registry) error {
...
func (m *ServiceConnectedGithubVCSSandboxConfigRequest) validateRepo(formats strfmt.Registry) error {
...
func (m *ServiceConnectedGithubVCSSandboxConfigRequest) UnmarshalBinary(b []byte) error {
	var res ServiceConnectedGithubVCSSandboxConfigRequest
