...
func (m *AppComponentReleaseStep) validateCreatedBy(formats strfmt.Registry) error {
...
func (m *AppComponentReleaseStep) contextValidateCreatedBy(ctx context.Context, formats strfmt.Registry) error {
