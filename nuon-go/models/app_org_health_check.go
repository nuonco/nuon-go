...
func (m *AppOrgHealthCheck) validateStatus(formats strfmt.Registry) error {
...
func (m *AppOrgHealthCheck) contextValidateStatus(ctx context.Context, formats strfmt.Registry) error {
