...
type RemoveUserParams struct {
	...
	/* Req.
	   ...
	   Input
	*/
	Req *models.ServiceRemoveOrgUserRequest
...
// WithReq adds the req to the remove user params
func (o *RemoveUserParams) WithReq(req *models.ServiceRemoveOrgUserRequest) *RemoveUserParams {
	o.SetReq(req)
	return o
}

// SetReq adds the req to the remove user params
func (o *RemoveUserParams) SetReq(req *models.ServiceRemoveOrgUserRequest) {
	o.Req = req
}
