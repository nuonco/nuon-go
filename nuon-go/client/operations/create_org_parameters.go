...
// WithReq adds the req to the create org params
func (o *CreateOrgParams) WithReq(req *models.ServiceCreateOrgRequest) *CreateOrgParams {
	o.SetReq(req)
	return o
}

// SetReq adds the req to the create org params
func (o *CreateOrgParams) SetReq(req *models.ServiceCreateOrgRequest) {
	o.Req = req
}
