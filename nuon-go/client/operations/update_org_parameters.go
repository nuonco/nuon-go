...
// WithReq adds the req to the update org params
func (o *UpdateOrgParams) WithReq(req *models.ServiceUpdateOrgRequest) *UpdateOrgParams {
	o.SetReq(req)
	return o
}

// SetReq adds the req to the update org params
func (o *UpdateOrgParams) SetReq(req *models.ServiceUpdateOrgRequest) {
	o.Req = req
}
