...
func (o *GetFlowOK) Error() string {
	...
	return fmt.Sprintf("[GET /v1/flows/{flow_id}][%d] getFlowOK %s", 200, payload)
}
...
func (o *GetFlowBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /v1/flows/{flow_id}][%d] getFlowBadRequest %s", 400, payload)
}
...
func (o *GetFlowUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /v1/flows/{flow_id}][%d] getFlowUnauthorized %s", 401, payload)
}
...
func (o *GetFlowForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /v1/flows/{flow_id}][%d] getFlowForbidden %s", 403, payload)
}
...
func (o *GetFlowNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /v1/flows/{flow_id}][%d] getFlowNotFound %s", 404, payload)
}
...
func (o *GetFlowInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /v1/flows/{flow_id}][%d] getFlowInternalServerError %s", 500, payload)
}
