...
func (o *GetAppFlowsOK) Error() string {
	...
	return fmt.Sprintf("[GET /v1/apps/{app_id}/flows][%d] getAppFlowsOK %s", 200, payload)
}
...
func (o *GetAppFlowsBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /v1/apps/{app_id}/flows][%d] getAppFlowsBadRequest %s", 400, payload)
}
...
func (o *GetAppFlowsUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /v1/apps/{app_id}/flows][%d] getAppFlowsUnauthorized %s", 401, payload)
}
...
func (o *GetAppFlowsForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /v1/apps/{app_id}/flows][%d] getAppFlowsForbidden %s", 403, payload)
}
...
func (o *GetAppFlowsNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /v1/apps/{app_id}/flows][%d] getAppFlowsNotFound %s", 404, payload)
}
...
func (o *GetAppFlowsInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /v1/apps/{app_id}/flows][%d] getAppFlowsInternalServerError %s", 500, payload)
}
