...
func (o *GetInstallComponentOutputsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *GetInstallComponentOutputsOK) GetPayload() any {
	return o.Payload
}
