...
func (o *GetInstallActionRunStepReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *GetInstallActionRunStepOK) Error() string {
	...
	return fmt.Sprintf("[GET /v1/installs/{install_id}/actions/runs/{run_id}/steps/{step_id}][%d] getInstallActionRunStepOK %s", 200, payload)
}
...
func (o *GetInstallActionRunStepBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /v1/installs/{install_id}/actions/runs/{run_id}/steps/{step_id}][%d] getInstallActionRunStepBadRequest %s", 400, payload)
}
...
func (o *GetInstallActionRunStepUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /v1/installs/{install_id}/actions/runs/{run_id}/steps/{step_id}][%d] getInstallActionRunStepUnauthorized %s", 401, payload)
}
...
func (o *GetInstallActionRunStepForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /v1/installs/{install_id}/actions/runs/{run_id}/steps/{step_id}][%d] getInstallActionRunStepForbidden %s", 403, payload)
}
...
func (o *GetInstallActionRunStepNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /v1/installs/{install_id}/actions/runs/{run_id}/steps/{step_id}][%d] getInstallActionRunStepNotFound %s", 404, payload)
}
...
func (o *GetInstallActionRunStepInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /v1/installs/{install_id}/actions/runs/{run_id}/steps/{step_id}][%d] getInstallActionRunStepInternalServerError %s", 500, payload)
}
