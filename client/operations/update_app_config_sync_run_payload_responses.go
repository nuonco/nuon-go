...
func (o *UpdateAppConfigSyncRunPayloadCreated) Error() string {
	...
	return fmt.Sprintf("[PUT /v1/apps/{app_id}/config-sync-run/{app_config_sync_run_id}/payload][%d] updateAppConfigSyncRunPayloadCreated %s", 201, payload)
}
...
func (o *UpdateAppConfigSyncRunPayloadBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /v1/apps/{app_id}/config-sync-run/{app_config_sync_run_id}/payload][%d] updateAppConfigSyncRunPayloadBadRequest %s", 400, payload)
}
...
func (o *UpdateAppConfigSyncRunPayloadUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /v1/apps/{app_id}/config-sync-run/{app_config_sync_run_id}/payload][%d] updateAppConfigSyncRunPayloadUnauthorized %s", 401, payload)
}
...
func (o *UpdateAppConfigSyncRunPayloadForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /v1/apps/{app_id}/config-sync-run/{app_config_sync_run_id}/payload][%d] updateAppConfigSyncRunPayloadForbidden %s", 403, payload)
}
...
func (o *UpdateAppConfigSyncRunPayloadNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /v1/apps/{app_id}/config-sync-run/{app_config_sync_run_id}/payload][%d] updateAppConfigSyncRunPayloadNotFound %s", 404, payload)
}
...
func (o *UpdateAppConfigSyncRunPayloadInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /v1/apps/{app_id}/config-sync-run/{app_config_sync_run_id}/payload][%d] updateAppConfigSyncRunPayloadInternalServerError %s", 500, payload)
}
