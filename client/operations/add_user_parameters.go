...
// WithReq adds the req to the add user params
func (o *AddUserParams) WithReq(req *models.ServiceCreateOrgUserRequest) *AddUserParams {
	o.SetReq(req)
	return o
}

// SetReq adds the req to the add user params
func (o *AddUserParams) SetReq(req *models.ServiceCreateOrgUserRequest) {
	o.Req = req
}
