...
// WithPage adds the page to the get app input configs params
func (o *GetAppInputConfigsParams) WithPage(page *int64) *GetAppInputConfigsParams {
	o.SetPage(page)
	return o
}

// SetPage adds the page to the get app input configs params
func (o *GetAppInputConfigsParams) SetPage(page *int64) {
	o.Page = page
}
