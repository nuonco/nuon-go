...
func (o *GetInstallReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 200:
		...
		return result, nil
	case 400:
		result := NewGetInstallBadRequest()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
	...
	case 500:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[GET /v1/installs/{install_id}] GetInstall", response, response.Code())
	}
}
...
func (o *GetInstallOK) Error() string {
	...
	return fmt.Sprintf("[GET /v1/installs/{install_id}][%d] getInstallOK %s", 200, payload)
}
...
func (o *GetInstallOK) GetPayload() *models.AppInstall {
	return o.Payload
}
...
// NewGetInstallBadRequest creates a GetInstallBadRequest with default headers values
func NewGetInstallBadRequest() *GetInstallBadRequest {
	return &GetInstallBadRequest{}
}

/*
GetInstallBadRequest describes a response with status code 400, with default header values.

Bad Request
*/
type GetInstallBadRequest struct {
	Payload *models.StderrErrResponse
}

// IsSuccess returns true when this get install bad request response has a 2xx status code
func (o *GetInstallBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get install bad request response has a 3xx status code
func (o *GetInstallBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get install bad request response has a 4xx status code
func (o *GetInstallBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this get install bad request response has a 5xx status code
func (o *GetInstallBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this get install bad request response a status code equal to that given
func (o *GetInstallBadRequest) IsCode(code int) bool {
	return code == 400
}

// Code gets the status code for the get install bad request response
func (o *GetInstallBadRequest) Code() int {
	return 400
}

func (o *GetInstallBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /v1/installs/{install_id}][%d] getInstallBadRequest %s", 400, payload)
}

func (o *GetInstallBadRequest) String() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /v1/installs/{install_id}][%d] getInstallBadRequest %s", 400, payload)
}

func (o *GetInstallBadRequest) GetPayload() *models.StderrErrResponse {
	return o.Payload
}

func (o *GetInstallBadRequest) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func (o *GetInstallUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /v1/installs/{install_id}][%d] getInstallUnauthorized %s", 401, payload)
}
...
func (o *GetInstallUnauthorized) GetPayload() *models.StderrErrResponse {
	return o.Payload
}
...
func (o *GetInstallForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /v1/installs/{install_id}][%d] getInstallForbidden %s", 403, payload)
}
...
func (o *GetInstallForbidden) GetPayload() *models.StderrErrResponse {
	return o.Payload
}
...
func (o *GetInstallNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /v1/installs/{install_id}][%d] getInstallNotFound %s", 404, payload)
}
...
func (o *GetInstallNotFound) GetPayload() *models.StderrErrResponse {
	return o.Payload
}
...
func (o *GetInstallInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /v1/installs/{install_id}][%d] getInstallInternalServerError %s", 500, payload)
}
...
func (o *GetInstallInternalServerError) GetPayload() *models.StderrErrResponse {
	return o.Payload
}
