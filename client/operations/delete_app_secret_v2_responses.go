...
func (o *DeleteAppSecretV2Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *DeleteAppSecretV2BadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /v1/apps/{app_id}/secrets/{secret_id}][%d] deleteAppSecretV2BadRequest %s", 400, payload)
}
...
func (o *DeleteAppSecretV2Unauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /v1/apps/{app_id}/secrets/{secret_id}][%d] deleteAppSecretV2Unauthorized %s", 401, payload)
}
...
func (o *DeleteAppSecretV2Forbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /v1/apps/{app_id}/secrets/{secret_id}][%d] deleteAppSecretV2Forbidden %s", 403, payload)
}
...
func (o *DeleteAppSecretV2NotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /v1/apps/{app_id}/secrets/{secret_id}][%d] deleteAppSecretV2NotFound %s", 404, payload)
}
...
func (o *DeleteAppSecretV2InternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /v1/apps/{app_id}/secrets/{secret_id}][%d] deleteAppSecretV2InternalServerError %s", 500, payload)
}
