...
// WithComponentID adds the componentID to the delete component params
func (o *DeleteComponentParams) WithComponentID(componentID string) *DeleteComponentParams {
	o.SetComponentID(componentID)
	return o
}

// SetComponentID adds the componentId to the delete component params
func (o *DeleteComponentParams) SetComponentID(componentID string) {
