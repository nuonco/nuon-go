...
// WithReq adds the req to the create app params
func (o *CreateAppParams) WithReq(req *models.ServiceCreateAppRequest) *CreateAppParams {
	o.SetReq(req)
	return o
}

// SetReq adds the req to the create app params
func (o *CreateAppParams) SetReq(req *models.ServiceCreateAppRequest) {
	o.Req = req
}
