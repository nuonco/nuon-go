...
func (o *HandleWebhookCreated) Error() string {
	...
	return fmt.Sprintf("[POST /v1/vcs/handle-webhook][%d] handleWebhookCreated %s", 201, payload)
}
...
func (o *HandleWebhookBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /v1/vcs/handle-webhook][%d] handleWebhookBadRequest %s", 400, payload)
}
...
func (o *HandleWebhookUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /v1/vcs/handle-webhook][%d] handleWebhookUnauthorized %s", 401, payload)
}
...
func (o *HandleWebhookForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /v1/vcs/handle-webhook][%d] handleWebhookForbidden %s", 403, payload)
}
...
func (o *HandleWebhookNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /v1/vcs/handle-webhook][%d] handleWebhookNotFound %s", 404, payload)
}
...
func (o *HandleWebhookInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /v1/vcs/handle-webhook][%d] handleWebhookInternalServerError %s", 500, payload)
}
