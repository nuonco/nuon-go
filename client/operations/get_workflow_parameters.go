...
// WithWorkflowID adds the workflowID to the get workflow params
func (o *GetWorkflowParams) WithWorkflowID(workflowID string) *GetWorkflowParams {
	o.SetWorkflowID(workflowID)
	return o
}

// SetWorkflowID adds the workflowId to the get workflow params
func (o *GetWorkflowParams) SetWorkflowID(workflowID string) {
