...
func (o *UpdateVCSConnectionBranchCreated) Error() string {
	...
	return fmt.Sprintf("[PATCH /v1/vcs/connections/{connection_id}/branches/{connection_branch_id}][%d] updateVCSConnectionBranchCreated %s", 201, payload)
}
...
func (o *UpdateVCSConnectionBranchBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /v1/vcs/connections/{connection_id}/branches/{connection_branch_id}][%d] updateVCSConnectionBranchBadRequest %s", 400, payload)
}
...
func (o *UpdateVCSConnectionBranchUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /v1/vcs/connections/{connection_id}/branches/{connection_branch_id}][%d] updateVCSConnectionBranchUnauthorized %s", 401, payload)
}
...
func (o *UpdateVCSConnectionBranchForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /v1/vcs/connections/{connection_id}/branches/{connection_branch_id}][%d] updateVCSConnectionBranchForbidden %s", 403, payload)
}
...
func (o *UpdateVCSConnectionBranchNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /v1/vcs/connections/{connection_id}/branches/{connection_branch_id}][%d] updateVCSConnectionBranchNotFound %s", 404, payload)
}
...
func (o *UpdateVCSConnectionBranchInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /v1/vcs/connections/{connection_id}/branches/{connection_branch_id}][%d] updateVCSConnectionBranchInternalServerError %s", 500, payload)
}
