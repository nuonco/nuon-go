...
func (o *UpdateAppBranchOK) Error() string {
	...
	return fmt.Sprintf("[POST /v1/apps/{app_id}/branches/{app_branch_id}/update][%d] updateAppBranchOK %s", 200, payload)
}
...
func (o *UpdateAppBranchBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /v1/apps/{app_id}/branches/{app_branch_id}/update][%d] updateAppBranchBadRequest %s", 400, payload)
}
...
func (o *UpdateAppBranchUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /v1/apps/{app_id}/branches/{app_branch_id}/update][%d] updateAppBranchUnauthorized %s", 401, payload)
}
...
func (o *UpdateAppBranchForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /v1/apps/{app_id}/branches/{app_branch_id}/update][%d] updateAppBranchForbidden %s", 403, payload)
}
...
func (o *UpdateAppBranchNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /v1/apps/{app_id}/branches/{app_branch_id}/update][%d] updateAppBranchNotFound %s", 404, payload)
}
...
func (o *UpdateAppBranchInternalServerError) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /v1/apps/{app_id}/branches/{app_branch_id}/update][%d] updateAppBranchInternalServerError %s", 500, payload)
}
